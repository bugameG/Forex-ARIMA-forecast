...
fcast_table |> datatable(colnames = c("date", "actual value (Ksh.)", "fitted value (Ksh.)", "absolute deviation (Ksh.)","lower bound (Ksh.)", "upper bound (Ksh.)"))
```
...
fcast_table2 |> 
  ...
  datatable(colnames = c("Date", "Predicted rate (Ksh.)", "Lower bound (Ksh.)", "Upper bound (Ksh.)"))
  # datatable(colnames = c("date", "rate (Ksh.)", "lower bound (Ksh.)", "upper bound (Ksh.)"))
```
